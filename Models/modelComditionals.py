...
Your task is to provide a list of conditions for participation, no introductory information and your thoughts.\
If there are no conditions, there are no conditions. In all other cases, return only the list and nothing else. \
Start your answer right from the first condition. Use only russian chars in your answear. Condition start with Number (1,2 ... n) and then set '.'
